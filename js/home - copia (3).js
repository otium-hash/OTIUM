...
/* =====================================================
   ...
   - Si existe configuración de carrusel,
     agrega los slides configurados SIN eliminar
     los slides originales.
...
function renderConfiguredCarousel(
    ...
    /* ---------------------------------------------
       ...
       LOS SLIDES ORIGINALES DE index.html
       SE CONSERVAN.
    --------------------------------------------- */
    ...
    validItems.forEach(
        item => {
             ...
             *
             * Esto permite eliminarlo posteriormente
             * sin tocar los slides originales.
             */
     ...
     *
     * Ahora carouselSlides contiene:
     *
     * 1. Banners configurados
     * 2. Eventos configurados
     * 3. Slides originales de index.html
     */
