...
* El menú funciona en TODAS las páginas.
* Si #menuOTIUM no existe, se crea automáticamente.
* No depende de que cada HTML tenga manualmente el contenedor.
* Mantiene el menú de usuario.
* Mantiene login/logout.
* Mantiene Mis avisos.
* Mantiene Mis recordatorios.
* Mantiene Mis entradas.
* Mantiene Favoritos.
* Mantiene Publicar evento.
* Mantiene Planes.
* Mantiene interruptor Push ON/OFF.
* Mantiene mensajes de confirmación Push.
* Marca automáticamente la página actual.
* No modifica el contenido del Home.
* Compatible con login.js.
* Compatible con notificaciones-push.js.

NOTA:
navbar.html y footer.html pueden seguir existiendo.
Este archivo garantiza que el navbar esté presente
aunque una página no tenga #menuOTIUM.
===================================================== */
...
/* =================================================
   ESTILOS ESPECÍFICOS DEL INTERRUPTOR PUSH
================================================= */
    ...
    logoutButton.addEventListener(
        ...
        async function() {
            ...
            try {
                ...
                /*
                 * login.js / auth.js puede encargarse
                 * de la función real de logout.
                 *
                 * Si existe window.logout,
                 * la utilizamos.
                 */
...
if (
    ...
    publishEvent.addEventListener(
        ...
        function(event) {
            ...
            /*
             * No bloqueamos el comportamiento normal.
             *
             * create-event.js / auth.js pueden
             * controlar posteriormente el acceso.
             */
